const CityAdminTemplate = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-100">
    <div class="max-w-screen-lg mx-auto mt-8">
        ...
        <div class="bg-white shadow-md rounded-lg px-8 py-6 mt-8">
            ...
            <p class="text-gray-700 mt-2">Thank you for registering on our application as a CityAdmin. You are successfully registered and welcome to our platform!</p>
